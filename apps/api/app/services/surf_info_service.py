...
class SurfInfoService:
    ...
    def _to_surf_info(cls, item: dict) -> dict:
        ...
        return {
            ...
            "nameKo": location.get("displayNameKo", {}).get("S", "") or None,
            "region": location.get("state", {}).get("S", ""),
            "regionKo": location.get("stateKo", {}).get("S", "") or None,
            "country": location.get("country", {}).get("S", ""),
            "countryKo": location.get("countryKo", {}).get("S", "") or None,
            "address": location.get("displayName", {}).get("S", ""),
            "addressKo": location.get("displayNameKo", {}).get("S", "") or None,
            "city": location.get("city", {}).get("S", ""),
            "cityKo": location.get("cityKo", {}).get("S", "") or None,
