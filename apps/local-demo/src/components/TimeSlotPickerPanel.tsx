...
import { getGradeBgColor, getGradeTextColor, getGradeBorderColor, getMetricsForLevel, parseUTCTimestamp } from '../services/surfInfoService';
  ...
  return (
    <div
      className={`
        ...
        md:bottom-0 md:animate-none md:rounded-none md:left-auto md:right-0 md:max-h-none md:w-[420px]
